...
1. 可使用[dictzip](https://dictzip.github.io/)或者[dictzip for Windows 10 (x64)](https://github.com/KaseyJenkins/dictzip-win64)转换StarDict字典文件到`.dz`格式。StarDict的`.ifo`文件里最好不要有中文
1. 参考[dictd.md](https://scillidan.github.io/notes/serve/dictd.html)部署`dictd`服务
...
1. `git clone https://gist.github.com/scillidan/e95773454d79dc047aeed016fb00daef tencenttrans_2zh_zh2en`
1. `cd tencenttrans_2zh_zh2en`
1. 参考脚本里的注释：
   1. `pip install tencentcloud-sdk-python langid`
   1. 需要填写API的`SecretId`和`SecretKey`
1. 程序 → 添加：
